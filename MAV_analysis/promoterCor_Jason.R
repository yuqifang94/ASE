...
pattern <- 'run2'
awf <- sub('.bw','',sub('NME-','',list.files('/home-4/zji4@jhu.edu/scratch/mousereprogram/data/wgbs/mm10/')))
...
library(splines)
expr <- readRDS(paste0('/home-4/zji4@jhu.edu/scratch/mousereprogram/res/fit/data/',pattern,'.rds'))
