...
human_NME_MAV.R: using MAV and NME, MML to generate Fig 6, etc and calculate correlation for human
mouse_NME_MAV.R: using MAV and NME, MML to generate MAV analysis for mouse 