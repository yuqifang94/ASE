...
d <- readRDS(paste0('/home-4/zji4@jhu.edu/scratch/tmp/',type,'_matrix_mouse_all_dedup_N2_all_regions.rds'))
...
pdf(paste0('/home-4/zji4@jhu.edu/scratch/andy_ASE/MDS/',type,'_tissue.pdf'),width=5.5,height=4.5)
...
dev.off()
pdf(paste0('/home-4/zji4@jhu.edu/scratch/andy_ASE/MDS/',type,'_time.pdf'),width=5.5,height=4.5)
