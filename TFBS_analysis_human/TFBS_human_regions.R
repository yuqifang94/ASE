...
setwd("/dcl02/hongkai/data/wzhou14/Andy_lab/yuqi_project/TFBS_analysis")
...
DNase_region <- readRDS("/dcl02/hongkai/data/wzhou14/Andy_lab/share/DNase_hg19_250bp.rds")
...
system("~/cisgenome_project/bin/refgene_getmatchedcontrol -d /users/wzhou14/cisgenome_project/hg19/annotation/refFlat_sorted.txt -dt 1 -s human -c /users/wzhou14/cisgenome_project/hg19/chrlen.txt -i DNase_hg19_250bp.cod -o DNase_hg19_250bp_control.cod -n 1 -l 250 -nr 1")
