...
melt_mm10<-function(GR_in){
    GR_in_dt=convert_GR(GR_in,dir='DT')
    GR_in_dt = melt.data.table(GR_in_dt,id.var='region',value.name='NME',variable.name='Sample')
    GR_in_dt=convert_GR(GR_in_dt,dir='GR')
    GR_in_dt$Sample=gsub('\\.','_',GR_in_dt$Sample)
    return(GR_in_dt)
}
#DNase NME
