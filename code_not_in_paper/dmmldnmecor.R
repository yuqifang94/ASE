...
saveRDS(dmmlcor,file='/dcl01/hongkai/data/zji4/ase/mouse/res/dmmldnmecor/dmmlcor.rds')
saveRDS(dnmecor,file='/dcl01/hongkai/data/zji4/ase/mouse/res/dmmldnmecor/dnmecor.rds')
